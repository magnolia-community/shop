...
import info.magnolia.shop.app.field.definition.TaxCategoriesSelectFieldDefinition;
...
public class TaxCategoriesSelectFieldFactory extends SelectFieldFactory<TaxCategoriesSelectFieldDefinition> {
    ...
    public List<SelectFieldOptionDefinition> getSelectFieldOptionDefinition() {
        ...
        try {
            ...
            String sql = "select * from [shopTaxCategory] where isdescendantnode([/" + shopName + "])";
            NodeIterator iter = QueryUtil.search(ShopRepositoryConstants.SHOPS, sql, Query.JCR_SQL2, "shopTaxCategory");
            while (iter.hasNext()) {
