 ...
 *
 */
package info.magnolia.module.shop.validators;
 ...
 * @author Will Schheidegger
 */
public class ShopCustomerCountryValidator extends Validator {
    private static Logger log = LoggerFactory.getLogger(ShopCustomerCountryValidator.class);

    /**
     * This validator method only updates the shopping cart before the confirm
     * page. 
     * @param value
     * @return 
     */
