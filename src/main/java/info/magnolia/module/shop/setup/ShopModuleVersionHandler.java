    ...
    public ShopModuleVersionHandler() {
        ...
        register(DeltaBuilder.update("2.1.1", "")
                ...
                .addTask(new ArrayDelegateTask("Remove properties",
                        ...
                        new NodeExistsDelegateTask("Set title property if /modules/shop/templates/components/features/shopProductCategory node exists", "", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductCategory", new SetPropertyTask("", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductCategory", "title", "shop.templates.components.features.shopProductCategory.title")),
                        ...
                        new NodeExistsDelegateTask("Set title property if /modules/shop/templates/components/features/shopProductSearchResult", "", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductSearchResult", new SetPropertyTask("", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductSearchResult", "title", "shop.templates.components.features.shopProductSearchResult.title")),
                        ...
                        new NodeExistsDelegateTask("Set title property if /modules/shop/templates/components/features/shopProductKeywordResult node exists", "", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductKeywordResult", new SetPropertyTask("", RepositoryConstants.CONFIG, "/modules/shop/templates/components/features/shopProductKeywordResult", "title", "shop.templates.components.features.shopProductKeywordResult.title")),
                        new NodeExistsDelegateTask("Set description property if /modules/shop/templates/components/teasers/shopProductTeaser/areas/linkList node exists", "", RepositoryConstants.CONFIG, "/modules/shop/templates/components/teasers/shopProductTeaser/areas/linkList", new SetPropertyTask("", RepositoryConstants.CONFIG, "/modules/shop/templates/components/teasers/shopProductTeaser/areas/linkList", "description", "shop.templates.components.teasers.shopProductTeaser.areas.linkList.description")),
