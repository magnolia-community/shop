...
public class ShopModuleVersionHandler extends DefaultModuleVersionHandler {
    ...
    public ShopModuleVersionHandler() {
        ...
        register(DeltaBuilder.update("2.0.0", "")
                        ...
                        .addTask(new ArrayDelegateTask("Install apps", "Install apps to manage shops, products, suppliers and carts.",
                                new BootstrapSingleModuleResource("apps/config.modules.shop.apps.shop.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING),
                                new BootstrapSingleModuleResource("apps/config.modules.shop.apps.shops.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING),
                                new BootstrapSingleModuleResource("apps/config.modules.shop.apps.shopSuppliers.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING),
                                new BootstrapSingleModuleResource("apps/config.modules.shop.apps.shopProducts.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING),
                                new BootstrapSingleModuleResource("apps/config.modules.shop.apps.shoppingCarts.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING)
                        ))
        ...
        register(DeltaBuilder.update("2.2", "")
                        .addTask(new NodeExistsDelegateTask("Setting name property of folderNodeType in shoppingCarts", "Setting name property in folderNodeType to value mgnl:folder in shoppingCarts contentConnector.", RepositoryConstants.CONFIG, "/modules/shop/apps/shoppingCarts/subApps/browser/contentConnector/nodeTypes", null,
                                new PartialBootstrapTask("Setting folderNodeType in shoppingCarts", "Setting name property in folderNodeType to mgnl:folder in shoppingCarts contentConnector.", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shoppingCarts.xml", "/shoppingCarts/subApps/browser/contentConnector/nodeTypes")))
                        ...
                        .addTask(new NodeExistsDelegateTask("Configure deletedCountries node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedCountries", null,
                                new PartialBootstrapTask("Configure deletedCountries node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedCountries")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedCountry node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedCountry", null,
                                new PartialBootstrapTask("Configure deletedCountry node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedCountry")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedCurrencies node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedCurrencies", null,
                                new PartialBootstrapTask("Configure deletedCurrencies node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedCurrencies")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedCurrency node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedCurrency", null,
                                new PartialBootstrapTask("Configure deletedCurrency node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedCurrency")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedPriceCategories node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedPriceCategories", null,
                                new PartialBootstrapTask("Configure deletedPriceCategories node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedPriceCategories")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedPriceCategory node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedPriceCategory", null,
                                new PartialBootstrapTask("Configure deletedPriceCategory node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedPriceCategory")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShippingOption node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedShippingOption", null,
                                new PartialBootstrapTask("Configure deletedShippingOption node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedShippingOption")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShippingOptions node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedShippingOptions", null,
                                new PartialBootstrapTask("Configure deletedShippingOptions node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedShippingOptions")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShop node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedShop", null,
                                new PartialBootstrapTask("Configure deletedShop node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedShop")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedTaxCategories node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedTaxCategories", null,
                                new PartialBootstrapTask("Configure deletedTaxCategories node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedTaxCategories")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedTaxCategory node in shop/apps/shop/subApps/browser/actionbar/sections node", "/modules/shop/apps/shop/subApps/browser/actionbar/sections/deletedTaxCategory", null,
                                new PartialBootstrapTask("Configure deletedTaxCategory node in shop/apps/shop/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shop.xml", "/shop/subApps/browser/actionbar/sections/deletedTaxCategory")))
                        .addTask(new NodeExistsDelegateTask("Configure addFolder action in shop/apps/shoppingCarts/subApps/browser/actions node", "/modules/shop/apps/shoppingCarts/subApps/browser/actions/addFolder", null,
                                new PartialBootstrapTask("Configure addFolder action in shop/apps/shoppingCarts/subApps/browser/actions node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shoppingCarts.xml", "/shoppingCarts/subApps/browser/actions/addFolder")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedFolder node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/deletedFolder", null,
                                new PartialBootstrapTask("Configure deletedFolder node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/deletedFolder")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShopProduct node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/deletedShopProduct", null,
                                new PartialBootstrapTask("Configure deletedShopProduct node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/deletedShopProduct")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShopProductOption node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/deletedShopProductOption", null,
                                new PartialBootstrapTask("Configure deletedShopProductOption node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/deletedShopProductOption")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedShopProductOptions node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/deletedShopProductOptions", null,
                                new PartialBootstrapTask("Configure deletedShopProductOptions node in shop/apps/shopProducts/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/deletedShopProductOptions")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/folder/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/groups node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/folder/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/folder/groups/previousVersionActions")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProduct/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/groups node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProduct/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProduct/groups/previousVersionActions")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProductOption/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/groups node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOption/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProductOption/groups/previousVersionActions")))
                        .addTask(new NodeExistsDelegateTask("Configure activate action in /modules/shop/apps/shopProducts/subApps/browser/actions node", "/modules/shop/apps/shopProducts/subApps/browser/actions/activate", new ValueOfPropertyDelegateTask("", "/modules/shop/apps/shopProducts/subApps/browser/actions/activate", "class", "info.magnolia.ui.framework.action.ActivationActionDefinition", false,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/activate"))))
                        .addTask(new NodeExistsDelegateTask("Configure deactivate action in /modules/shop/apps/shopProducts/subApps/browser/actions node", "/modules/shop/apps/shopProducts/subApps/browser/actions/deactivate", new ValueOfPropertyDelegateTask("", "/modules/shop/apps/shopProducts/subApps/browser/actions/deactivate", "class", "info.magnolia.ui.framework.action.DeactivationActionDefinition", false,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/deactivate"))))
                        .addTask(new NodeExistsDelegateTask("Configure activateDeletion node in shop/apps/shopProducts/subApps/browser/actions node", "/modules/shop/apps/shopProducts/subApps/browser/actions/activateDeletion", null,
                                new PartialBootstrapTask("Configure activateDeletion node in shop/apps/shopProducts/subApps/browser/actions node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/activateDeletion")))
                        .addTask(new NodeExistsDelegateTask("Configure restorePreviousVersion action in shop/apps/shopProducts/subApps/browser/actions node", "/modules/shop/apps/shopProducts/subApps/browser/actions/restorePreviousVersion", null,
                                new PartialBootstrapTask("Configure restorePreviousVersion action in shop/apps/shopProducts/subApps/browser/actions node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/restorePreviousVersion")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actions/editShopProductOption/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actions/editShopProductOption/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actions/editShopProductOption/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/editShopProductOption/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actions/editShopProductOptions/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actions/editShopProductOptions/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actions/editShopProductOptions/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actions/editShopProductOptions/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedFolder node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/deletedFolder", null,
                                new PartialBootstrapTask("Configure deletedFolder node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/deletedFolder")))
                        .addTask(new NodeExistsDelegateTask("Configure deletedSupplier node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/deletedSupplier", null,
                                new PartialBootstrapTask("Configure deletedSupplier node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/deletedSupplier")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/availability node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/folder/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/groups node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/folder/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/folder/groups/previousVersionActions")))
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/availability node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/supplier/availability")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/groups node", "/modules/shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopSuppliers/subApps/browser/actionbar/sections/supplier/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actionbar/sections/supplier/groups/previousVersionActions")))
                        .addTask(new NodeExistsDelegateTask("Configure activate action in /modules/shop/apps/shopSuppliers/subApps/browser/actions node", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/activate", new ValueOfPropertyDelegateTask("", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/activate", "class", "info.magnolia.ui.framework.action.ActivationActionDefinition", false,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actions/activate"))))
                        .addTask(new NodeExistsDelegateTask("Configure deactivate action in /modules/shop/apps/shopSuppliers/subApps/browser/actions node", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/deactivate", new ValueOfPropertyDelegateTask("", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/deactivate", "class", "info.magnolia.ui.framework.action.DeactivationActionDefinition", false,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actions/deactivate"))))
                        .addTask(new NodeExistsDelegateTask("Configure activateDeletion action in shop/apps/shopSuppliers/subApps/browser/actions node", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/activateDeletion", null,
                                new PartialBootstrapTask("Configure activateDeletion action in shop/apps/shopSuppliers/subApps/browser/actions node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actions/activateDeletion")))
                        .addTask(new NodeExistsDelegateTask("Configure restorePreviousVersion action in shop/apps/shopSuppliers/subApps/browser/actions node", "/modules/shop/apps/shopSuppliers/subApps/browser/actions/restorePreviousVersion", null,
                                new PartialBootstrapTask("Configure restorePreviousVersion action in shop/apps/shopSuppliers/subApps/browser/actions node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopSuppliers.xml", "/shopSuppliers/subApps/browser/actions/restorePreviousVersion")))
                        ...
                        .addTask(new NodeExistsDelegateTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/availability node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/availability/rules", null,
                                new PartialBootstrapTask("Configure rules node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/availability node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/availability/rules")))
                        .addTask(new NodeExistsDelegateTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/groups node", "/modules/shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/groups/previousVersionActions", null,
                                new PartialBootstrapTask("Configure previousVersionActions node in shop/apps/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/groups node", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shopProducts.xml", "/shopProducts/subApps/browser/actionbar/sections/shopProductOptions/groups/previousVersionActions")))
                        ...
                        .addTask(new NodeExistsDelegateTask("Configure availability in /modules/shop/apps/shoppingCarts/subApps/browser/actionbar/sections/folders node if not exists", "/modules/shop/apps/shoppingCarts/subApps/browser/actionbar/sections/folders/availability", null,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shoppingCarts.xml", "/shoppingCarts/subApps/browser/actionbar/sections/folders/availability")))
                        .addTask(new NodeExistsDelegateTask("Configure section multiple in /modules/shop/apps/shoppingCarts/subApps/browser/actionbar/sections node if not exists", "/modules/shop/apps/shoppingCarts/subApps/browser/actionbar/sections/multiple", null,
                                new PartialBootstrapTask("", "/mgnl-bootstrap/shop/apps/config.modules.shop.apps.shoppingCarts.xml", "/shoppingCarts/subApps/browser/actionbar/sections/multiple")))
                        .addTask(new NodeExistsDelegateTask("Check for the existence of company node.", "/modules/shop/dialogs/createSupplier/form/tabs/address/fields/company",
                                new CheckOrCreatePropertyTask("Configure supplier company as mandatory property.", "/modules/shop/dialogs/createSupplier/form/tabs/address/fields/company", "required", "true")))
                        .addTask(new NodeExistsDelegateTask("Check for the existence of categories node.", "/modules/shop/apps/shopProducts/subApps/detail/editor/form/tabs/categories/fields/categories/field",
                                new CheckOrCreatePropertyTask("Escape product categories names on the product detail dialog.", "/modules/shop/apps/shopProducts/subApps/detail/editor/form/tabs/categories/fields/categories/field", "targetPropertyToPopulate", "displayName")))
    ...
    private List<Task> getTasksFor_2_3_0() {
        ...
        tasks.add(new BootstrapSingleModuleResource("Updating currency dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createCurrency.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating price category dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createPriceCategory.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating product options dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createShopProductOptions.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating product option dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createShopProductOption.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating shipping option dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createShippingOption.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating supplier dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createSupplier.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating tax category dialog", "Enabling localization for selected fields", "dialogs/config.modules.shop.dialogs.createTaxCategory.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating products dialog", "Enabling localization for selected fields and fixing labels", "apps/config.modules.shop.apps.shopProducts.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating shop app", "Fixing labels", "apps/config.modules.shop.apps.shop.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
        tasks.add(new BootstrapSingleModuleResource("Updating shops app", "Fixing labels", "apps/config.modules.shop.apps.shops.xml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING));
