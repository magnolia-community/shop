 ...
 *
 */
package info.magnolia.shop.checkout;
...
public class ShopStartStepFormEngine extends StartStepFormEngine {
    ...
    public ShopStartStepFormEngine(Node configurationNode, FormParagraph configurationParagraph, RenderingContext context, TranslationService translationService, I18nContentSupport i18nContentSupport) {
        super(configurationNode, configurationParagraph, context, translationService, i18nContentSupport);
    }
    ...
    protected String getFormStateToken() throws FormStateTokenMissingException, RepositoryException {
        ...
        } catch (FormStateTokenMissingException | RepositoryException e) {
            // next, look in cart!
            if (cart != null) {
