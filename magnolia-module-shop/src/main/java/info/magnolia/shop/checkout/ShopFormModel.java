...
public class ShopFormModel extends FormModel {
    ...
    public ShopFormModel(Node content, RenderableDefinition definition, RenderingModel<?> parent, TemplatingFunctions functions, SimpleTranslator translator) {
        super(content, definition, parent, functions, translator);
    }
